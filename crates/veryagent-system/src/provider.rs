...
use veryagent_api_types::{CreateProviderRequest, ProviderResponse, UpdateProviderRequest};
use veryagent_common::{decrypt_string, encrypt_string};
use veryagent_db::{CreateProviderParams, IProviderRepository, UpdateProviderParams, models::Provider};
...
mod tests {
    use super::*;
    use veryagent_db::{SqliteProviderRepository, init_database_memory};
    ...
    fn validate_create_bedrock_allows_empty_base_url_and_api_key() {
        let req = CreateProviderRequest {
            ...
            base_url: "".into(),
            api_key: "".into(),
            bedrock_config: Some(veryagent_api_types::BedrockConfig {
                auth_method: veryagent_api_types::BedrockAuthMethod::Profile,
