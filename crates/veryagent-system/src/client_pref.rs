...
use veryagent_api_types::{ClientPreferencesResponse, UpdateClientPreferencesRequest};
use veryagent_db::IClientPreferenceRepository;
...
mod tests {
    use super::*;
    use veryagent_db::{SqliteClientPreferenceRepository, init_database_memory};
    use serde_json::json;
