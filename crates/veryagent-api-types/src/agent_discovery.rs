...
use veryagent_common::{AgentType, TimestampMs};
...
/// the frontend verbatim, and typed-decoded inside `veryagent-ai-agent`
...
pub struct AgentMetadata {
    ...
    /// Native mode id that VeryAgent's legacy `yolo` / `yoloNoSandbox`
