...
use veryagent_db::{DbError, IChannelRepository, SqliteChannelRepository, UpdatePluginStatusParams, init_database_memory};

async fn repo() -> (Arc<dyn IChannelRepository>, veryagent_db::Database) {
