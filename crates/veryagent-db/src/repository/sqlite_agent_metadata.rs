...
struct AgentMetadataSafeRow {
    ...
    last_check_at: Option<veryagent_common::TimestampMs>,
    last_success_at: Option<veryagent_common::TimestampMs>,
    last_failure_at: Option<veryagent_common::TimestampMs>,
    command_override: Option<String>,
    env_override: Option<String>,
    created_at: veryagent_common::TimestampMs,
    updated_at: veryagent_common::TimestampMs,
}
