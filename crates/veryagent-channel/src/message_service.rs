...
use veryagent_ai_agent::{AgentStreamEvent, IWorkerTaskManager};
use veryagent_api_types::{AssistantConversationRequest, CreateConversationRequest, SendMessageRequest};
use veryagent_common::{AgentType, ConversationSource};
...
mod tests {
    ...
    #[test]
    fn platform_to_source_reserved_defaults_to_veryagent() {
