...
use veryagent_db::{DbError, IChannelRepository};
use veryagent_extension::{ExtensionRegistry, ResolvedChannelPlugin};
use serde::Serialize;
...
mod tests {
    use super::*;
    use veryagent_api_types::TestPluginExtraConfig;
