...
use veryagent_api_types::{PairingRequestedPayload, UserAuthorizedPayload, WebSocketMessage};
use veryagent_common::{TimestampMs, generate_id, now_ms};
use veryagent_db::IChannelRepository;
use veryagent_db::models::{AssistantUserRow, PairingCodeRow};
