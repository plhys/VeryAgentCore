...
impl ChannelSettingsService {
    ...
    async fn effective_assistant_backend(
        &self,
        definition: &veryagent_db::models::AssistantDefinitionRow,
        overlays: &[veryagent_db::models::AssistantOverlayRow],
...
mod tests {
    ...
    use veryagent_db::{IAssistantDefinitionRepository, IAssistantOverlayRepository};
    use std::sync::Mutex;
