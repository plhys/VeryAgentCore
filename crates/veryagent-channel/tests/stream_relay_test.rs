...
use veryagent_ai_agent::AgentStreamEvent;
use veryagent_ai_agent::protocol::events::{
    ErrorEventData, FinishEventData, TextEventData, ToolCallEventData, ToolCallStatus,
};
use veryagent_channel::stream_relay::{ChannelStreamRelay, MessageRecorder, RelayConfig};
...
async fn weixin_flushes_pending_text_before_tool_call() {
    // Port of VeryAgent TS fix `406a62665` to the backend relay layer. On
