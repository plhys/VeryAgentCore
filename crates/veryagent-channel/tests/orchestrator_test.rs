...
async fn unauthorized_user_gets_pairing_response() {
    ...
    let repo: Arc<dyn veryagent_db::IChannelRepository> = Arc::new(veryagent_db::SqliteChannelRepository::new(pool.clone()));
    ...
    let pref_repo: Arc<dyn veryagent_db::IClientPreferenceRepository> =
        Arc::new(veryagent_db::SqliteClientPreferenceRepository::new(pool));
