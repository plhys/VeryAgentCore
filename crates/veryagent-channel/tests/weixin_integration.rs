...
mod weixin_tests {
    ...
    use veryagent_channel::manager::{ChannelManager, PluginFactory};
    use veryagent_channel::plugin::ChannelPlugin;
    use veryagent_channel::plugins::weixin::WeixinPlugin;
    use veryagent_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use veryagent_channel::plugins::weixin::weixin_login_stream;
