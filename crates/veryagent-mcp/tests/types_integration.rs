//! Integration tests for veryagent-mcp core types.
//!
...
use veryagent_mcp::{McpServer, McpServerTransport, McpTool};
...
fn tool_fields_preserved_through_conversion() {
    ...
    // Domain -> API response
    let resp: veryagent_api_types::McpToolResponse = tool.clone().into();
