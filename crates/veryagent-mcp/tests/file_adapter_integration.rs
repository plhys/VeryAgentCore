...
use veryagent_mcp::{AionuiAdapter, McpAgentAdapter, McpServerTransport};
...
mod veryagent {
    ...
    use veryagent_db::{CreateMcpServerParams, DbError, IMcpServerRepository, UpdateMcpServerParams};
    ...
    impl IMcpServerRepository for MockRepo {
        ...
        async fn update_status(
            ...
            _id: &str,
            _s: &str,
            _lc: Option<veryagent_common::TimestampMs>,
        ) -> Result<(), DbError> {
            unimplemented!()
        }
...
mod opencode {
    use super::*;
    use veryagent_mcp::OpencodeAdapter;
...
mod aionrs {
    use super::*;
    use veryagent_mcp::AionrsAdapter;
