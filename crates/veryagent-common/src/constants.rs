...
pub const VERYAGENT_TIMESTAMP_SEPARATOR: &str = "_veryagent_";
pub const VERYAGENT_FILES_MARKER: &str = "[[AION_FILES]]";
...
pub const COOKIE_NAME: &str = "veryagent-session";
pub const COOKIE_MAX_AGE_DAYS: u32 = 30;
pub const CSRF_COOKIE_NAME: &str = "veryagent-csrf-token";
