...
//!
//! These test the public API surface of `veryagent_extension::manifest`.

use veryagent_extension::{ExtensionError, ExtensionManifest, parse_manifest, validate_manifest};
