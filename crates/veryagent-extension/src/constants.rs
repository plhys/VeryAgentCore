...
/// Well-known skill source name for the veryagent skills market.
pub const SKILLS_MARKET_NAME: &str = "veryagent-skills";

/// Well-known skill source path for the veryagent skills market.
///
...
pub const SKILLS_MARKET_PATH: &str = "https://github.com/AionUI/veryagent-skills";
