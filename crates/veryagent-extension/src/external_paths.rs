...
///
/// Data is stored in `~/.veryagent/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the veryagent skills market by adding it to external paths.
    ...
    /// Disable the veryagent skills market by removing it from external paths.
