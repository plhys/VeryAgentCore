...
const EXTENSION_STATES_FILE_ENV: &str = "VERYAGENT_EXTENSION_STATES_FILE";
...
/// Resolve the extension state file path using the historical VeryAgent rules.
///
/// Priority:
/// 1. `VERYAGENT_EXTENSION_STATES_FILE`
