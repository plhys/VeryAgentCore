...
use veryagent_common::{ApiError, now_ms};
use serde_json::json;
...
impl From<ExtensionError> for ApiError {
    fn from(err: ExtensionError) -> Self {
        match err {
            ...
            ExtensionError::Db(veryagent_db::DbError::NotFound(msg)) => ApiError::NotFound(msg),
            ExtensionError::Db(veryagent_db::DbError::Conflict(msg)) => ApiError::Conflict(msg),
