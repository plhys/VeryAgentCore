...
use veryagent_db::{IAcpSessionRepository, SaveRuntimeStateParams};
...
impl AcpSessionSyncService {
    ...
    pub async fn load_persisted(&self, conversation_id: &str) -> Option<veryagent_db::PersistedSessionState> {
...
mod tests {
    ...
    use veryagent_db::{CreateAcpSessionParams, SqliteAcpSessionRepository, init_database_memory};
