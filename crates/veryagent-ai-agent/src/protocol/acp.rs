...
const ACP_CLIENT_NAME: &str = "VeryAgent";
...
/// Log a JSON-RPC request from VeryAgent to the ACP agent.
...
/// Log a fire-and-forget notification from VeryAgent to the agent.
...
/// Log a JSON-RPC response from VeryAgent back to the agent.
...
mod tests {
    ...
    fn initialize_request_sends_non_empty_client_info() {
        ...
        assert_eq!(client_info.name, "VeryAgent");
        ...
        assert_eq!(json["clientInfo"]["name"], "VeryAgent");
