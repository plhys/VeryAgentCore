            ...
            let classified = acp_agent_internal_texts(message, data.as_ref())
                ...
                .find_map(|text| {
                    ...
                    classify_agent_lifecycle(&lower)
                        ...
                        .or_else(|| classify_veryagent_state(&lower))
...
fn classify_veryagent_state(lower: &str) -> Option<ClassifiedError> {
...
mod tests {
    use super::*;
    use veryagent_api_types::{AgentErrorResolutionKind, AgentErrorResolutionTarget};
    use serde_json::json;
    ...
    #[test]
    fn preserves_runtime_workspace_validation_as_structured_veryagent_error() {
        let err =
    ...
    fn classifies_agent_setup_failures() {
        ...
        for managed_binary_missing in [
            "expected managed Claude ACP platform binary missing: C:\\Users\\user\\AppData\\Roaming\\VeryAgent\\veryagent\\runtime\\acp\\claude-agent-acp\\0.39.0\\win32-x64\\node_modules\\@anthropic-ai\\claude-agent-sdk-win32-x64\\claude.exe",
            "expected managed Codex ACP platform binary missing: C:\\Users\\user\\AppData\\Roaming\\VeryAgent\\veryagent\\runtime\\acp\\codex-acp\\0.14.0\\win32-x64\\node_modules\\@zed-industries\\codex-acp-win32-x64\\bin\\codex-acp.exe",
        ] {
            assert_classification(
    ...
    #[test]
    fn classifies_veryagent_conversation_busy_after_agent_and_provider_checks() {
        assert_classification(
