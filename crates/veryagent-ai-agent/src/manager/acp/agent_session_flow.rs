...
use veryagent_api_types::SlashCommandItem;
...
impl AcpAgentManager {
    ...
    async fn emit_snapshot_events(&self) {
        use veryagent_api_types::{ModelInfoEntry, ModelInfoPayload};
...
mod tests {
    ...
    use veryagent_api_types::{AgentErrorCode, SlashCommandCompletionBehavior, SlashCommandItem};
