...
/// Wired up by `veryagent-app` so deleting a conversation tears down its
...
mod tests {
    ...
    use veryagent_common::{AgentKillReason, AgentType, ConversationStatus, ProviderWithModel};
