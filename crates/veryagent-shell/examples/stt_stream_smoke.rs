...
//!   cargo run -p veryagent-shell --example stt_stream_smoke -- /path/to/pcm16-24k-mono.wav

use veryagent_api_types::{
    DeepgramSpeechToTextConfig, OpenAISpeechToTextConfig, SpeechToTextConfig, SpeechToTextProvider,
};
use veryagent_shell::{ProviderUpstreamFactory, UpstreamEvent, UpstreamFactory};
