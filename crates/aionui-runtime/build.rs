...
//!   and `[package.metadata.aionui-runtime] bun_version` from Cargo.toml.
...
//! - Caches decompressed+compressed artifacts in `$CARGO_HOME/aionui-bun-cache/`.
...
fn main() {
    ...
    // AIONUI_EMBED_NODE is unset. Real population happens in Task A5.
...
fn read_bun_version() -> String {
    ...
    parsed
        ...
        .and_then(|v| v.as_str())
        .expect("[package.metadata.aionui-runtime] bun_version missing")
        .to_string()
}
