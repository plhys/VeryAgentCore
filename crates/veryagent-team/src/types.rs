...
use veryagent_api_types::{TeamAgentResponse, TeamResponse};
...
mod tests {
    ...
    #[test]
    fn teammate_status_parse_veryagent_aliases() {
    ...
    #[test]
    fn teammate_status_serde_veryagent_aliases() {
    ...
    #[test]
    fn team_agent_deserialize_veryagent_format() {
