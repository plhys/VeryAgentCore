...
use veryagent_api_types::{BrowseDirectoryResponse, BrowseEntry};
...
/// projects (iOfficeAI/VeryAgent#3191) — so strip the prefix before serializing.
...
mod tests {
    ...
    // Regression tests for iOfficeAI/VeryAgent#3191: responses must never carry
