...
const NOISE_SUPPRESSIONS: &[&str] = &[
    ...
    // out of default dev logs; veryagent_ai_agent::protocol::acp emits sanitized
...
mod tests {
    ...
    fn env_filter_suppresses_raw_acp_sdk_jsonrpc_debug_even_when_debug_enabled() {
        ...
        tracing::subscriber::with_default(subscriber, || {
            ...
            assert!(
                tracing::enabled!(target: "veryagent_ai_agent::protocol::acp", Level::DEBUG),
                "VeryAgent ACP sanitized debug summaries should still be available"
            );
        });
    }
    ...
    fn env_filter_suppresses_raw_aionrs_provider_debug_even_when_debug_enabled() {
        ...
        tracing::subscriber::with_default(subscriber, || {
            ...
            assert!(
                tracing::enabled!(target: "veryagent_ai_agent::manager::aionrs::agent", Level::DEBUG),
                "VeryAgent aionrs lifecycle debug logs should still be available"
            );
        });
    }
