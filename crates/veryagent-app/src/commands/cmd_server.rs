...
use veryagent_api_types::{RuntimeStatusScope, RuntimeStatusScopeKind};
use veryagent_app::{AppConfig, AppServices, RouterBuildError, create_router};
use veryagent_system::RuntimePrepareService;
...
pub(crate) async fn run_server(
    ...
    tokio::spawn(async move {
        ...
        let result = async {
            ...
            runtime_prepare_service
                ...
                .await?;
            Ok::<(), veryagent_system::SystemError>(())
        }
        .await;
    ...
    let idle_scanner_handle =
        veryagent_ai_agent::start_idle_scanner(services.worker_task_manager.clone(), shutdown_rx, None, None);
